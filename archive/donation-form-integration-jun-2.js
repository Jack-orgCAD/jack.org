        ...
        if (parsedResponse.Success === true) {
          ...
          dataLayer.push({
            ...
            ecommerce: {
                ...
                currency: "CAD",
                affiliation: "raisin",
                fundraising_campaign_name: Object.values(CONFIG.utmSourceMapping)[0],
                fundraising_campaign_id: Object.keys(CONFIG.utmSourceMapping)[0],
                form_id: Object.keys(CONFIG.utmSourceMapping)[0],
                form_name: Object.values(CONFIG.utmSourceMapping)[0],
                form_type: "donation",
                items: [
                    {
                        item_id: `0_${donationAmount}`,
                        item_name: `$${donationAmount}`,
                        item_brand: Object.values(CONFIG.utmSourceMapping)[0],
